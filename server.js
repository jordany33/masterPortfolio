...
// this is what allows us to specify routes
app.use( '/', router );
app.use( express.static( __dirname + '/masterPortfolio' ));

// get root dir (https://jordany.dev/) & send to index.html
router.get( '/', ( req, res ) => 
{
    res.sendFile( 'masterPortfolio/index.html', { root: __dirname } );
});

// possible alternate dir
router.get( '/projects', ( req, res ) => 
{
    res.sendFile( 'masterPortfolio/projects.html', { root: __dirname } );
});
